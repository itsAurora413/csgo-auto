...
func (r *GetTemplatePurchaseOrderListResponse) UnmarshalJSON(data []byte) error {
	...
	if err := json.Unmarshal(data, &t); err != nil {
		return fmt.Errorf("解析GetTemplatePurchaseOrderListResponse失败: %w", err)
	}
