...
func (c *OpenAPIClient) SearchPurchaseOrderList(ctx context.Context, req *SearchPurchaseOrderListRequest) (*SearchPurchaseOrderListResponse, error) {
	...
	err := c.tokenClient.makeRequestWithGzip(ctx, "POST", "/api/youpin/bff/trade/purchase/order/searchPurchaseOrderList", req, &response, false)
	if err != nil {
...
// GetBalances 获取账户余额（代理到tokenClient）
func (o *OpenAPIClient) GetBalances(ctx context.Context) (*AccountBalances, error) {
	if o.tokenClient == nil {
		return nil, fmt.Errorf("Token客户端未初始化，无法获取账户余额")
	}
	return o.tokenClient.GetBalances(ctx)
}
